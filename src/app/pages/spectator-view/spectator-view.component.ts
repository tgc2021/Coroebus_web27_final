...
export class SpectatorViewComponent implements OnInit {
  ...
  getDashboardGroup() {
    ...
    if (this.userObj.games.length > 0) {
      let body_gamerankingList = {
        ...
        _game: this.selected_gameID?.game?.id_coroebus_game
      }
  ...
  async spectSearch() {
    ...
    body = {
      ...
      "_game": this.selected_gameID?.game?.id_coroebus_game ? this.selected_gameID?.game?.id_coroebus_game : this.userSelectionData?.id_coroebus_game,
      "page_number": 1,
