...
export const isNotNullOrEmptyString = (value: any) =>
...
export const isEmptyObject = (value: any) => Object.keys(value).length;

export const isarrayLengthGtToZero = (value: any) => value.length > 0;
